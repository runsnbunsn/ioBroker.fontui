...
vis.binds["fontui"] = {
	...
	createWidget: function (widgetID, view, data, style) {
		...
		var animationTwoSettings = "";
		if(data.animationName != "none") {
			animationSettings += " animation-name: " + data.animationName;
		}
		if(data.animationTwoName != "none") {
			animationTwoSettings += " animation-name: " + data.animationTwoName;
		}
		animationSettings +=	"; animation-duration: " + data.animationDuration + "s;";
		animationTwoSettings +=	"; animation-duration: " + data.animationTwoDuration + "s;";
		animationSettings += "animation-iteration-count: infinite;"
		animationTwoSettings += "animation-iteration-count: infinite;"

		var text = "<div class=\"fontui-widget vis-widget-body\" style=\"padding-top:10px;" + animationTwoSettings + "\">";
